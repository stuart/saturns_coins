...
// *
    ...
    /* Modified for DrSaturn's Coin System. */
    #include "eldo_inc_loot"
    ...
    void CreateGold(object oTarget, object oAdventurer, int nTreasureType, int nModifier = 0)
    {
        ...
        // * always at least 1cp is created
        nAmount = FloatToInt(nAmount * nMod * 100); // *100 to generate cents.
        if (nAmount <= 0)
        {
            nAmount = 1;
        }
        ELDOCreateGold(oTarget, nTreasureType, nAmount);
}
